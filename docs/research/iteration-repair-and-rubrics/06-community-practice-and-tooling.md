...
0. [Verification constraints](#verification-constraints)
...
| [**Argos**](https://github.com/argos-ci/argos) / Chromatic / Percy | See §7.2 | The hosted gate with a review UI and an approve/reject workflow. All three advertise a free entry tier; none of their pricing pages was reachable. `[pricing unverified]` |
